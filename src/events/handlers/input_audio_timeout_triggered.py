"""Handler for ``input_audio_timeout_triggered`` events.

Docs: https://openai.github.io/openai-agents-python/ref/realtime/events/#agents.realtime.events.RealtimeInputAudioTimeoutTriggered
"""
...
@server_router.register_for("input_audio_timeout_triggered")
