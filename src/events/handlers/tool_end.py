"""Handler for ``tool_end`` events.

Docs: https://openai.github.io/openai-agents-python/ref/realtime/events/#agents.realtime.events.RealtimeToolEnd
"""
...
@server_router.register_for("tool_end")
